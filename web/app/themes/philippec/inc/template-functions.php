 ...
 * @return array
 */
function philippec_body_classes($classes)
{
	...
	if (is_customize_preview()) {
		$classes[] = 'philippec-customizer';
	}

	// Add class on front page.
	if (is_front_page() && 'posts' !== get_option('show_on_front')) {
		$classes[] = 'philippec-front-page';
	}
...
add_filter('body_class', 'philippec_body_classes');
 ...
 */
function philippec_panel_count()
{
 ...
 */
function philippec_is_frontpage()
{
